...
A total of `r length(unique(res_all$subject))` participants completed our study; demographics are shown in \Cref{fig:demographics}.
...
While each participant was provided with 15 trials, `r sum(res_sub_count$n < 15)` participants did not complete the entire experiment.
