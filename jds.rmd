...
All responses ($n = `r nrow(res_all) - nrow(res)`$) that incorrectly identified the smaller bar were removed from the study before analysis; this serves as a basic attention check. In addition, one trial was removed because the participant did not enter a valid ID for a 3D printed chart.
