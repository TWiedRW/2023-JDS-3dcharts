...
Participants were provided a kit with five 3D-printed charts corresponding to five of the seven unique ratio comparisons. In the Shiny application, we asked participants for the kit ID, which was used to look up the corresponding digital renderings. This ensured that the experimental design was balanced across chart type and randomized with respect to the type of comparison (adjacent or separated).
We printed 21 kits containing five 3d-printed charts each, where 2 of the 7 ratios were randomly removed from the total set.
