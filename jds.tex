...
A total of 38 participants completed the study; demographics are shown in \Cref{fig:demographics}.
The participants provided a total of \texttt{nrow(res\_all)} responses.
...
All responses that incorrectly identified the smaller bar (\(n = 18\)) were removed from the study before analysis; this serves as a basic attention check and leaves 477 valid responses. In addition, one response was removed because the participant did not enter a valid ID for a 3D printed chart.
