...
\begin{figure}
\includegraphics[width=0.85\linewidth]{jds_files/figure-latex/demographics-1} \caption{Demographic breakdown of participants in the study. All subjects were recruited from faculty and students in the statistics department at University of Nebraska-Lincoln.}\label{fig:demographics}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{jds_files/figure-latex/midmeans-log-errors-1} \caption{Midmeans of log absolute errors for the true ratio of bars. Each overlaying line are computed with loess.}\label{fig:midmeans-log-errors}
\end{figure}
